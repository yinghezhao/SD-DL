...
%       if size(varargin) = 2, then use physio information and save PSC_vals
    ...
    % calculate PSC
    beta_condition_dir = [dir_GLM '\beta_0001.nii'];
    beta_constant_dir = [dir_GLM '\beta_0008.nii'];
    if size(varargin) == 1
        beta_constant_dir = [dir_GLM '\beta_0022.nii'];
    end
    spmmat_dir = [dir_GLM '\SPM.mat'];
