function matlabbatch = Batch_PreProcess_R2analyse_echo2(dir_Reference, dir_T1raw, dir_3D_Realigned,dir_model, multi_reg)
...
matlabbatch{2}.spm.spatial.preproc.tissue(1).tpm = {'D:\MySoftwares\MATLAB\toolbox\spm12\tpm\TPM.nii,1'};
